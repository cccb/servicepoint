...
RustBuffer uniffi_servicepoint_binding_uniffi_fn_method_chargrid_get_col(void*_Nonnull ptr, uint64_t x, RustCallStatus *_Nonnull out_status
);
RustBuffer uniffi_servicepoint_binding_uniffi_fn_method_chargrid_get_row(void*_Nonnull ptr, uint64_t y, RustCallStatus *_Nonnull out_status
);
...
void uniffi_servicepoint_binding_uniffi_fn_method_chargrid_set_col(void*_Nonnull ptr, uint64_t x, RustBuffer col, RustCallStatus *_Nonnull out_status
);
...
uint16_t uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_get_col(void
    
);
uint16_t uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_get_row(void
...
uint16_t uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_set_col(void
