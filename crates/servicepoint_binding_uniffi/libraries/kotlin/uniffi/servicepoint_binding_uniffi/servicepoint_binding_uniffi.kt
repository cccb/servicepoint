...
internal interface _UniFFILib : Library {
    ...
    fun uniffi_servicepoint_binding_uniffi_fn_method_bitvec_copy_raw(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_servicepoint_binding_uniffi_fn_method_bitmap_copy_raw(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_servicepoint_binding_uniffi_fn_method_brightnessgrid_copy_raw(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_servicepoint_binding_uniffi_fn_free_chargrid(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Unit
    fun uniffi_servicepoint_binding_uniffi_fn_constructor_chargrid_clone(`other`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Pointer
    fun uniffi_servicepoint_binding_uniffi_fn_constructor_chargrid_load(`data`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): Pointer
    fun uniffi_servicepoint_binding_uniffi_fn_constructor_chargrid_new(`width`: Long,`height`: Long,_uniffi_out_err: RustCallStatus, 
    ): Pointer
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_as_string(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_equals(`ptr`: Pointer,`other`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Byte
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_fill(`ptr`: Pointer,`value`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): Unit
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_get(`ptr`: Pointer,`x`: Long,`y`: Long,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_get_col(`ptr`: Pointer,`x`: Long,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_get_row(`ptr`: Pointer,`y`: Long,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_height(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Long
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_set(`ptr`: Pointer,`x`: Long,`y`: Long,`value`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): Unit
    fun uniffi_servicepoint_binding_uniffi_fn_method_chargrid_set_col(`ptr`: Pointer,`x`: Long,`col`: RustBuffer.ByValue,_uniffi_out_err: RustCallStatus, 
    ): Unit
    ...
    fun uniffi_servicepoint_binding_uniffi_fn_method_cp437grid_copy_raw(`ptr`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): RustBuffer.ByValue
    ...
    fun uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_get_col(
    ): Short
    fun uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_get_row(
    ): Short
    ...
    fun uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_set_col(
    ): Short
...
private fun uniffiCheckApiChecksums(lib: _UniFFILib) {
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_bitvec_copy_raw() != 12617.toShort()) {
    ...
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_bitmap_copy_raw() != 3467.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_brightnessgrid_copy_raw() != 28155.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_as_string() != 46581.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_equals() != 17533.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_fill() != 56996.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_set() != 64815.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_chargrid_set_col() != 43727.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_method_cp437grid_copy_raw() != 50937.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    ...
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_constructor_chargrid_clone() != 61241.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_constructor_chargrid_load() != 47815.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_servicepoint_binding_uniffi_checksum_constructor_chargrid_new() != 13303.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
class BitVec(
    ...
    override fun `copyRaw`(): ByteArray =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_bitvec_copy_raw(it,
...
class Bitmap(
    ...
    override fun `copyRaw`(): ByteArray =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_bitmap_copy_raw(it,
...
class BrightnessGrid(
    ...
    override fun `copyRaw`(): ByteArray =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_brightnessgrid_copy_raw(it,
...
class CharGrid(
    pointer: Pointer
) : FFIObject(pointer), CharGridInterface {
    constructor(`width`: ULong, `height`: ULong) :
        this(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_constructor_chargrid_new(FfiConverterULong.lower(`width`),FfiConverterULong.lower(`height`),_status)
})
    ...
    override protected fun freeRustArcPtr() {
        rustCall() { status ->
            _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_free_chargrid(this.pointer, status)
        }
    }
    ...
    override fun `asString`(): String =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_as_string(it,
    ...
    override fun `equals`(`other`: CharGrid): Boolean =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_equals(it,
        FfiConverterTypeCharGrid.lower(`other`),
        _status)
}
        }.let {
            FfiConverterBoolean.lift(it)
    ...
    @Throws(CharGridException::class)override fun `fill`(`value`: String) =
        callWithPointer {
    rustCallWithError(CharGridException) { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_fill(it,
    ...
    override fun `get`(`x`: ULong, `y`: ULong): String =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_get(it,
        FfiConverterULong.lower(`x`),FfiConverterULong.lower(`y`),
        _status)
}
        }.let {
    ...
    override fun `height`(): ULong =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_height(it,
    ...
    @Throws(CharGridException::class)override fun `set`(`x`: ULong, `y`: ULong, `value`: String) =
        callWithPointer {
    rustCallWithError(CharGridException) { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_set(it,
        FfiConverterULong.lower(`x`),FfiConverterULong.lower(`y`),FfiConverterString.lower(`value`),
        _status)
}
        }
    ...
    @Throws(CharGridException::class)override fun `setCol`(`x`: ULong, `col`: String) =
        callWithPointer {
    rustCallWithError(CharGridException) { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_set_col(it,
        FfiConverterULong.lower(`x`),FfiConverterString.lower(`col`),
        _status)
}
        }
    ...
    @Throws(CharGridException::class)override fun `setRow`(`y`: ULong, `row`: String) =
        callWithPointer {
    rustCallWithError(CharGridException) { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_set_row(it,
        FfiConverterULong.lower(`y`),FfiConverterString.lower(`row`),
        _status)
}
        }
    ...
    override fun `width`(): ULong =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_chargrid_width(it,
    ...
    companion object {
        fun `clone`(`other`: CharGrid): CharGrid =
            CharGrid(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_constructor_chargrid_clone(FfiConverterTypeCharGrid.lower(`other`),_status)
})
        fun `load`(`data`: String): CharGrid =
            CharGrid(
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_constructor_chargrid_load(FfiConverterString.lower(`data`),_status)
})
...
public object FfiConverterTypeCharGrid: FfiConverter<CharGrid, Pointer> {
    override fun lower(value: CharGrid): Pointer = value.callWithPointer { it }
    ...
    override fun allocationSize(value: CharGrid) = 8
...
class Cp437Grid(
    ...
    override fun `copyRaw`(): ByteArray =
        callWithPointer {
    rustCall() { _status ->
    _UniFFILib.INSTANCE.uniffi_servicepoint_binding_uniffi_fn_method_cp437grid_copy_raw(it,
...
sealed class CharGridException: Exception() {
    ...
    class InvalidSeriesLength(
        val `actual`: ULong, 
        val `expected`: ULong
        ) : CharGridException() {
        override val message
            get() = "actual=${ `actual` }, expected=${ `expected` }"
    }
    ...
    companion object ErrorHandler : CallStatusErrorHandler<CharGridException> {
...
public object FfiConverterTypeCharGridError : FfiConverterRustBuffer<CharGridException> {
    override fun read(buf: ByteBuffer): CharGridException {
        ...
        return when(buf.getInt()) {
            ...
            2 -> CharGridException.InvalidSeriesLength(
                FfiConverterULong.read(buf),
                FfiConverterULong.read(buf),
                )
            3 -> CharGridException.OutOfBounds(
                FfiConverterULong.read(buf),
                FfiConverterULong.read(buf),
                )
    ...
    override fun allocationSize(value: CharGridException): Int {
        return when(value) {
