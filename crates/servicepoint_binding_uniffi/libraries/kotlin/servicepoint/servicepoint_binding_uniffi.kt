...
internal interface _UniFFILib : Library {
    ...
    fun uniffi_servicepoint_binding_uniffi_fn_method_bitvec_uniffi_trait_eq_eq(`ptr`: Pointer,`other`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Byte
    fun uniffi_servicepoint_binding_uniffi_fn_method_bitvec_uniffi_trait_eq_ne(`ptr`: Pointer,`other`: Pointer,_uniffi_out_err: RustCallStatus, 
    ): Byte
